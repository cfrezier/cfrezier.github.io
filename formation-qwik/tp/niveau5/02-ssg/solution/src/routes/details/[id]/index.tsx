...
import {
  ...
  RequestEventAction,
  routeAction$,
  routeLoader$, StaticGenerateHandler,
  validator$
...
export const facorizedValidator = validator$(async (ev, data: any) => {
...
export const useEditAction = routeAction$(factorized('PUT'), facorizedValidator);

export const useAddAction = routeAction$(factorized('POST'), facorizedValidator);
