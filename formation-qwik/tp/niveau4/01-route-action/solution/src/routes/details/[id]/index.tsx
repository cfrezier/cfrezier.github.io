...
export const factorized = (method: string) => async (user: JSONObject, {fail}: RequestEventAction<any>) => {
...
export const useEditAction = routeAction$(factorized('PUT'));

export const useAddAction = routeAction$(factorized('POST'));